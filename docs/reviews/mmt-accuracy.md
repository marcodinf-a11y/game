...
| F12 | Low | No currency demand mechanism (Chartalism) | **Resolved** (doc note only) — MVP simplification note added to ECONOMIC-MODEL.md; mechanism itself is post-MVP with foreign sector, see #6 |
